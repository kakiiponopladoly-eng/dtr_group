...
export default async function FoundationPage({
  ...
  return (
    <div>
      {/* Hero — brand green from logo */}
      <section className="bg-green-600 py-24 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <p className="label-tag text-green-300 mb-6">{t("title")}</p>
          <h1
          ...
          <p className="text-green-200/80 text-lg leading-relaxed max-w-2xl">
            {t("description")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 border border-cream-200">
            {pillars.map(({ Icon, label }, i) => (
              ...
              >
                <div className="w-10 h-10 border border-green-200 flex items-center justify-center flex-shrink-0 bg-green-50">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-gray-100">
            <div className="p-10 border-b md:border-b-0 md:border-r border-gray-100">
              <div className="w-10 h-10 border border-green-200 bg-green-50 flex items-center justify-center mb-6">
