        ...
        <div className="max-w-7xl mx-auto">
          {serviceKeys.map((key, i) => {
            ...
            return (
              ...
              >
                <span className="font-display font-black text-3xl text-gray-150 leading-none pt-1 group-hover:text-orange-200 transition-colors">
                  {String(i + 1).padStart(2, "0")}
                </span>
                <div className="w-12 h-12 border border-gray-100 flex items-center justify-center flex-shrink-0 group-hover:border-orange-200 group-hover:bg-orange-50 transition-colors">
